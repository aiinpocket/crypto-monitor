...
public enum AchievementDef {
    ...
    // 特殊事件稱號（虧損怪物遭遇）
    SURVIVOR_20("深淵倖存者", "在單筆交易虧損超過 20% 的深淵中存活", 30),
    SURVIVOR_30("虛空見證者", "在單筆交易虧損超過 30% 的虛空中見證毀滅", 60),
    SURVIVOR_40("末日歸來者", "在單筆交易虧損超過 40% 的末日審判中歸來", 120),

    // 特殊事件稱號（獲利怪物擊敗）
    SLAYER_20("黃金獵手", "擊敗單筆獲利 20%+ 召喚的黃金哥布林王", 50),
    SLAYER_30("翡翠征服者", "擊敗單筆獲利 30%+ 召喚的翡翠龍王", 80),
    SLAYER_40("鑽石霸主", "擊敗單筆獲利 40%+ 召喚的鑽石泰坦", 150);
